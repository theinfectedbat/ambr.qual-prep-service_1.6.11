 ...
 */
@RestController
public class GetGPMSourceIVABySourceFromPartitionServiceAPI 
{
	...
	public static final String	URL_PATH_PREFIX							= "/qps/api/gpmsrciva_universe_partition/get_gpmsrciva_by_source/";
     ...
     *************************************************************************************
     */
	public GetGPMSourceIVABySourceFromPartitionServiceAPI()
		throws Exception
	{
	}
	...
	public GPMSourceIVAProductSourceContainer execute(@PathVariable(name = URL_PATH_VARIABLE_NAME_PROD_SRC_KEY) long theProdSrcKey)
		throws Exception
	{
		return this.partition.getSourceIVABySource(theProdSrcKey);
	}
