...
public class ArQtxWorkUtility
{
	...
	public List<QualTX> getImpactedQtxCompKeys(ArrayList<Long> altKeyList, long reasonCode) throws Exception
	{
		...
		if (reasonCode == ReQualificationReasonCodes.GPM_CTRY_CMPL_ADDED) sql.append(this.getSimpleClause("COMP.PROD_SRC_IVA_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_CTRY_CMPL_DELETED) sql.append(this.getSimpleClause("COMP.PROD_CTRY_CMPL_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_IVA_AND_CLAIM_DTLS_CHANGE) sql.append(this.getSimpleClause("COMP.PROD_SRC_IVA_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_SRC_IVA_DELETED) sql.append(this.getSimpleClause("COMP.PROD_SRC_IVA_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_SRC_CHANGE) sql.append(this.getSimpleClause("COMP.PROD_SRC_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_SRC_DELETED) sql.append(this.getSimpleClause("COMP.PROD_SRC_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_SRC_ADDED) sql.append(this.getSimpleClause("COMP.PROD_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.BOM_COMP_MODIFIED) sql.append(this.getSimpleClause("COMP.SRC_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.BOM_COMP_DELETED) sql.append(this.getSimpleClause("COMP.SRC_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.BOM_COMP_ADDED) sql.append(this.getSimpleClause("COMP.SRC_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.BOM_COMP_YARN_DTLS_CHG) sql.append(this.getSimpleClause("COMP.SRC_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.BOM_COMP_SRC_CHG) sql.append(this.getSimpleClause("COMP.SRC_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_COMP_FINAL_DECISION_CHANGE) sql.append(this.getSimpleClause("COMP.PROD_SRC_IVA_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_IVA_CHANGE_M_I) sql.append(this.getSimpleClause("COMP.PROD_SRC_IVA_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_COMP_CUMULATION_CHANGE) sql.append(this.getSimpleClause("COMP.PROD_SRC_IVA_KEY", "=", "OR", altKeyList.size()));
		if (reasonCode == ReQualificationReasonCodes.GPM_COMP_TRACE_VALUE_CHANGE) sql.append(this.getSimpleClause("COMP.PROD_SRC_IVA_KEY", "=", "OR", altKeyList.size()));
