 ...
 *****************************************************************************************
 */
public class QualTXDetailUniversePartitionEventHandler
	implements SubordinateServiceEventHandler
{
	QualTXDetailUniverse		universe;
     ...
     *************************************************************************************
     */
	QualTXDetailUniversePartitionEventHandler(QualTXDetailUniverse theBOMUniverse)
		throws Exception
	{
		this.universe = theBOMUniverse;
	}
