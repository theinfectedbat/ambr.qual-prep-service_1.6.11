 ...
 *****************************************************************************************
 */
public class GetGPMClassStatusFromPartitionClientAPI 
{
	private static Logger		logger = LogManager.getLogger(GetGPMClassStatusFromPartitionClientAPI.class);
     ...
     *************************************************************************************
     */
	public GetGPMClassStatusFromPartitionClientAPI(SubordinateServiceReference theServiceRef)
		throws Exception
	{
     ...
     *************************************************************************************
     */
	public GetGPMClassStatusFromPartitionClientAPI(
		...
		throws Exception
	{
		...
		aResponse = aTemplate.getForEntity(
			new URI(MessageFormat.format("{0}{1}", this.serviceURL, GetGPMClassStatusFromPartitionServiceAPI.GetURLPath(thePaddingLength))), 
			String.class
		);
