 ...
 */
@RestController
public class BOMUniverseBOMServiceAPI 
{
	...
	public static final String		URL_PATH_PREFIX					= "/qps/api/bom_universe/get_bom/";
     ...
     *************************************************************************************
     */
	public BOMUniverseBOMServiceAPI()
		throws Exception
	{
	...
	public BOM execute(@PathVariable(name = URL_PATH_VARIABLE_NAME_BOM_KEY) long theBOMKey)
		throws Exception
	{
		return this.bomUniverse.getBOM(theBOMKey);
	}
