 ...
 *****************************************************************************************
 */
public class GetPartnerDetailStatusFromPartitionClientAPI 
{
	private static Logger		logger = LogManager.getLogger(GetPartnerDetailStatusFromPartitionClientAPI.class);
     ...
     *************************************************************************************
     */
	public GetPartnerDetailStatusFromPartitionClientAPI(SubordinateServiceReference theServiceRef)
		throws Exception
	{
     ...
     *************************************************************************************
     */
	public GetPartnerDetailStatusFromPartitionClientAPI(
		...
		throws Exception
	{
		...
		aResponse = aTemplate.getForEntity(
			new URI(MessageFormat.format("{0}{1}", this.serviceURL, GetPartnerDetailStatusFromPartitionServiceAPI.GetURLPath(thePaddingLength))), 
			String.class
		);
