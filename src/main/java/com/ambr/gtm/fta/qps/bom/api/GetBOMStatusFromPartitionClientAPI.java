 ...
 *****************************************************************************************
 */
public class GetBOMStatusFromPartitionClientAPI 
{
	private static Logger		logger = LogManager.getLogger(GetBOMStatusFromPartitionClientAPI.class);
     ...
     *************************************************************************************
     */
	public GetBOMStatusFromPartitionClientAPI(SubordinateServiceReference theServiceRef)
		throws Exception
	{
     ...
     *************************************************************************************
     */
	public GetBOMStatusFromPartitionClientAPI(
		...
		throws Exception
	{
		...
		aResponse = aTemplate.getForEntity(
			new URI(MessageFormat.format("{0}{1}", this.serviceURL, GetStatusFromPartitionServiceAPI.GetURLPath(thePaddingLength))), 
			String.class
		);
