 ...
 */
@RestController
public class GetGPMSourceIVAByProductFromPartitionServiceAPI 
{
	...
	public static final String	URL_PATH_PREFIX						= "/qps/api/gpmsrciva_universe_partition/get_gpmsrciva_by_product/";
     ...
     *************************************************************************************
     */
	public GetGPMSourceIVAByProductFromPartitionServiceAPI()
		throws Exception
	{
	}
	...
	public GPMSourceIVAProductContainer execute(@PathVariable(name = URL_PATH_VARIABLE_NAME_PROD_KEY) long theProdKey)
		throws Exception
	{
		return this.partition.getSourceIVAByProduct(theProdKey);
	}
