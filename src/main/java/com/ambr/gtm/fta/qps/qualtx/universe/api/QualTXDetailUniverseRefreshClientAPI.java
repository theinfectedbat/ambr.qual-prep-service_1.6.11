 ...
 *****************************************************************************************
 */
public class QualTXDetailUniverseRefreshClientAPI 
{
	private static Logger		logger = LogManager.getLogger(QualTXDetailUniverseRefreshClientAPI.class);
     ...
     *************************************************************************************
     */
	public QualTXDetailUniverseRefreshClientAPI(URL theURL)
		throws Exception
	{
     ...
     *************************************************************************************
     */
	public QualTXDetailUniverseRefreshClientAPI(String theProtocol, String theHost, int thePort)
		throws Exception
	{
		...
		throws Exception
	{
		...
		aResponseEntity = aTemplate.exchange(
			this.serviceURL + QualTXDetailUniverseRefreshAPI.URL_PATH, 
			HttpMethod.POST, 
			null, 
			Void.class
		);
